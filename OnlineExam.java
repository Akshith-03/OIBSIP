...
class Question {
 ...
 class OnlineExam {
    ...
    private static void initializeQuestions() {
        ...
        questions.add(new Question("What is the capital of Telangana?", List.of("Chennai", "kolkata", "Hyderabad", "Lucknow"),3));
    ...
    private static void login() {
        ...
        currentUser = new User(username, password, "Akshith N");
